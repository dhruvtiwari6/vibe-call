...
function UserChat() {
  ...
  const VideoCallHandler = () => {
    console.log('i have sent the request to call');
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (file) {
        ...
        fileControl = fileRes.data;
        console.log("file Control : ", fileControl);
      }
                        ...
                        <div className="mt-2">
                          {message.fileUrl.match(/\.(jpeg|jpg|gif|png|webp)$/i) ? (
                            <img
                              src={message.fileUrl}
                              alt="sent image"
                              className="rounded-xl border border-gray-200 max-w-[70vw] sm:max-w-[250px] md:max-w-[350px] max-h-[250px] sm:max-h-[250px] md:max-h-[350px] object-cover"
                            />
                          ) : message.fileUrl.match(/\.(mp4|webm|ogg|mov)$/i) ? (
                            <VideoPlayer
                              src={message.fileUrl}
                              className="rounded-xl border border-gray-200 max-w-[80vw] sm:max-w-[300px] md:max-w-[400px] max-h-[250px] sm:max-h-[300px] md:max-h-[400px]"
                            />
                          ) : null}
                        </div>
                      )}
                        ...
                        <div className="mt-2">
                          {message.fileUrl.match(/\.(jpeg|jpg|gif|png|webp)$/i) ? (
                            ...
                            <video
                              src={message.fileUrl}
                              controls
                              className="rounded-xl border border-gray-200 max-w-[80vw] sm:max-w-[300px] md:max-w-[400px] max-h-[250px] sm:max-h-[300px] md:max-h-[400px] object-contain"
                            />
                          ) : null}
                        </div>
                      )}
